    ...
    <div className='intro'>
        <div className="i-left">
            ...
            <div className="i-icons">
                <a href="https://github.com/ramitgithub/portfolio">
                <img src={Github} alt="" />
                </a>
        ...
        <div className="i-right">
           ...
           <motion.div initial={{top: "18rem", left: '9rem'}} whileInView={{left:'0rem'}} transition={transition} style={{top:'18rem', left:'0rem'}} >
